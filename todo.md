...
- [ ] Add sound toggle / mute button (#2)
...
- [ ] Visual themes for enlightenment tiers (#3)
...
- [ ] Particle effects on karma milestones (#4)
...
- [ ] Leaderboard (total karma across players) (#5)
...
- [ ] Tutorial / onboarding overlay for new players (#6)
...
- [ ] Save export / import (JSON download) (#7)
...
- [ ] Prestige system beyond Nirvana (New Game+) (#8)
...
- [ ] Accessibility: screen reader support for key actions (#9)
...
- [ ] Mobile haptic feedback on events (#10)
