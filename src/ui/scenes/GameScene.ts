...
export class GameScene extends Container {
  ...
  private buildUI(): void {
    ...
    const tabColors = [0x2a6a2a, 0x1e5a1e];
    ...
    const confirmResetBtn = new ActionButton('Yes, Reset Everything', 450, 80, 0x2a6a2a, () => {
    ...
    const cancelResetBtn = new ActionButton('Cancel', 250, 70, 0x1e5a1e, () => {
      this.resetOverlay.visible = false;
    });
